...
// Additional notification costing default cost structure. All prices in $US
config.defaultCostSchedule = {
    prepaidUserCount:   1000,
    additionalUserRate: 1.05,        // Cost per additional user over the prepaid user amount in the customer's plan (e.g. $1.05).
    androidNotificationRate: 0.05,   // Cost per Android native notification sent (e.g. $0.05).
    iosNotificationRate: 0.05,       // Cost per iOS native notification sent (e.g. $0.05).
