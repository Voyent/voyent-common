...
config.service.proxy.enabled = false;
config.service.proxy.scheme = 'http';
config.service.proxy.host = config.env.host === LOCAL_HOST ? LOCAL_HOST : config.env.host;
config.service.proxy.port = config.env.host === LOCAL_HOST ? ':55000' : '';
config.service.proxy.url = config.service.proxy.scheme + '://' + config.service.proxy.host + config.service.proxy.port;
