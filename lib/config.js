...
//Information for communicating with the URL Shortener service.
config.us = {};
config.us.scheme = 'http';
config.us.host = config.env.host === LOCAL_HOST ? LOCAL_HOST : config.env.proxyHost;
config.us.port = config.env.host === LOCAL_HOST ? ':55170' : '';
config.us.path = '/us';
config.us.url = config.us.scheme + '://' + config.us.host + config.us.port + config.us.path;
