...
//Information for communicating with the Scope service.
config.shortener = {};
config.shortener.scheme = 'http';
config.shortener.host = config.env.host === LOCAL_HOST ? LOCAL_HOST : config.env.proxyHost;
config.shortener.port = config.env.host === LOCAL_HOST ? ':55170' : '';
config.shortener.path = '/shortener';
config.shortener.url = config.shortener.scheme + '://' + config.shortener.host + config.shortener.port + config.shortener.path;
