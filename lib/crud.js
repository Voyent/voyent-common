...
function assembleResourceQuery(barrel, cb) {
    ...
    // When there isn't a resourceId, say, as in a directory, we should be able to see all the resources
    // that we have access to. When there is a resourceId, it should be included in the query
    barrel.query = {
        $or: [
            {
