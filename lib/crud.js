...
//function getWaterfallActions(allowDBQuery, processData, finalAction) {
//
//    console.log('getWaterfallActions: ', allowDBQuery, processData, finalAction);
//
//    var waterfallActions = [
//        verifyAccount,
//        verifyRealm,
//        verifyAccessToken,
//        checkPermission
...
//
//    if (allowDBQuery) {
//        waterfallActions = waterfallActions.concat([
//            processResultsParameter,
//            processQueryParameter,
//            processFieldsParameter,
//            processOptionsParameter
//        ]);
//    }
//
//    if (processData && us.isFunction(processData)) {
//        waterfallActions = waterfallActions.concat([
//            validatePayload,
//            processData,
//            validateResource
...
//    ]);
//
//    return waterfallActions;
//}
//module.exports.getWaterfallActions = getWaterfallActions;
...
function checkPermission(barrel, cb) {
    ...
    logger.debug('checking permissions',
        '\n accountId: ' + barrel.accountId,
        '\n realmId: ' + barrel.realmId,
        '\n access_token: ' + barrel.accessToken,
        '\n permission: ' + barrel.permission);

    //Make sure the access_token has permission to do this action.
    authCall.validatePermission(barrel.accessToken, barrel.realmId, barrel.permission, function (err, results) {

        if (err) {
            return cb(new errors.AuthorizationError('permissionNotGranted'));
        }
...
function updateResource(barrel, cb) {
    ...
    if (!barrel.queryOptions.upsert || barrel.queryOptions.upsert !== false) {
