        ...
        barrel.collection.count(barrel.countQuery, function (err, count) {
                ...
                barrel.collection.update(barrel.query,
                    ...
                    function (err, doc) {
                        ...
                        // todo: This cant fail because the update has happened to some records.
                        if (doc != possibleRecordCount) {
                            logger.debug('Mismatch! update perm count: ' + possibleRecordCount +
                            ', updated record count: ' + doc);
                        }
                        cb(err, barrel);
                    });
            });
