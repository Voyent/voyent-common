...
function buildMailboxPayload(params) {
    ...
    ld.set(record, 'message.notificationType', params.notificationType);
...
function buildCloudPayload(params) {
    ...
    ld.set(record, 'notificationType', params.notificationType);
...
function buildBroadcastPayload(params) {
    ...
    ld.set(record, 'payload.global.notificationType', params.notificationType);
