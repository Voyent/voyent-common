...
function buildBroadcastPayload(params, userInfo) {
    ...
    if (params.notification.locationNames) {
        ld.set(record, 'payload.global.locationNames', params.notification.locationNames);
        delete params.notification.locationNames;
    }
    if (params.notification.affectedLocations) {
        ld.set(record, 'payload.global.affectedLocations', params.notification.affectedLocations);
        delete params.notification.affectedLocations;
    }
    if (params.notification.affectedTopics) {
        ld.set(record, 'payload.global.affectedTopics', params.notification.affectedTopics);
        delete params.notification.affectedTopics;
    }
    if (params.notification.acknowledgement) {
        ld.set(record, 'payload.global.acknowledgement', params.notification.acknowledgement);
        delete params.notification.acknowledgement;
    }
    if (params.notification.shareable) {
        ld.set(record, 'payload.global.shareable', params.notification.shareable);
        delete params.notification.shareable;
    }
