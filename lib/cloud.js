...
function adjustNotificationForProtocol(notification, userInfo) {
    ...
    let protocol =
        userInfo.notificationEndpoint.substring(0, userInfo.notificationEndpoint.indexOf(':'))
            .trim()
            .toLowerCase();
...
function buildServicesPayloads(params, userInfo) {
    ...
    // logger.debug('buildServicesPayloads', params.notificationEndpoint, JSON.stringify(payload));
