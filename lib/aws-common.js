...
function convertPropertyToAttribute(key, value) {
    ...
    if (ld.isUndefined(value) || ld.isEmpty(value)) {
        ...
        //Rather than ignore or kill undefined values, it's a bit easier to
        //set them to empty strings.  That way they will not cause errors
        //when you try to publish them and they will print out when you log
        //them making it a bit easier to debug.
        result = {};
        result[key] = {
            DataType: "String",
            StringValue: ""
