 ...
 * @param typeInPayload {String}    Optional type that will be passed through to the client/app to determine what to update. For example 'editAdmin'
 ...
 */
function publishAppUpdateEvent(account, realm, username, typeInPayload, txcode, fullPayload) {
