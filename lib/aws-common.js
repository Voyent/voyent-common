...
function saveEventToDB(event, cb) {
    ...
    newEvent._account = event.account;
    newEvent._realm = event.realm;
...
function getCurrentTopicPolicy(topicArn, cb) {
    ...
    awsClient.sns.getTopicAttributes(params, function (err, data) {
...
function updateCurrentPolicy(topicArn, currentPolicy, newStatement, cb) {
    ...
    awsClient.sns.setTopicAttributes(params, function (err, data) {
