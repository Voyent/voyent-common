...
function createQueue(topicName, queueName, cb) {
    ...
    async.waterfall([
        ...
        function (dlqArn, acb) {
            ...
            as.sqs.setQueueAttributes(params, acb);
        }
...
function createDeadLetterQueue(cb) {
    ...
    getQualifiedQueueName(topicName, queueName, function (err, qName) {
        ...
        as.sqs.createQueue(params, function (err, data) {
            ...
            getQueueArn(topicName, queueName, function (err, queueArn) {
                ...
                as.sqs.setQueueAttributes(params, function (err) {
...
function deleteQueue(topicName, queueName, cb) {
    ...
    getQueueUrl(topicName, queueName, function (err, qURL) {
        ...
        as.sqs.deleteQueue(params, function (err, data) {
            if (err) {
                cb(err);
                return;
            }
...
function createTopic(topicName, cb) {
    ...
    getQualifiedTopicName(topicName, function (err, tName) {
        ...
        as.sns.createTopic(params, function (err, data) {
...
function deleteTopic(topicName, cb) {
    ...
    getTopicArn(topicName, function (err, topicArn) {
        ...
        as.sns.deleteTopic(params, function (err, data) {
...
function getAllTopics(cb) {
    ...
    async.doWhilst(
        function (acb) {
            ...
            as.sns.listTopics(params, function (err, data) {
...
function getQueueUrl(topicName, queueName, cb) {
    ...
    getQualifiedQueueName(topicName, queueName, function (err, qName) {
        ...
        as.sqs.getQueueUrl(params, function (err, data) {
            if (err) {
                cb(err);
                return;
            }
...
function getQueueArn(topicName, queueName, cb) {
    ...
    getQueueUrl(topicName, queueName, function (err, qURL) {
        ...
        as.sqs.getQueueAttributes(params, function (err, data) {
...
function publishMessageToTopic(topicName, message, attrs, cb) {
    ...
    getTopicArn(topicName, function (err, topicArn) {
        ...
        as.sns.publish(params, function (err, data) {
...
function sendMessageToQueue(topicName, queueName, message, cb) {
    ...
    getQueueUrl(topicName, queueName, function (err, queueUrl) {
        ...
        as.sqs.sendMessage(params, function (err, data) {
...
function getSubscriptionsForTopic(topicArn, cb) {
    ...
    as.sns.listSubscriptionsByTopic(params, function (err, data) {
        if (err) {
            cb(err);
            return;
        }
    ...
    async.parallel({
        ...
        checkQueueAlreadySubscribed(
            ...
            function (err, sub) {
                ...
                as.sns.subscribe(params, function (err, data) {
    ...
    async.parallel({
        ...
        checkQueueAlreadySubscribed(
            ...
            function (err, sub) {
                ...
                as.sns.setSubscriptionAttributes(params, function (err, data) {
