...
function Environment() {
    ...
    this.HOSTNAMES = {
        ...
        DEV: 'dev.voyent.cloud',
        PROD: 'api.voyent.cloud',
        INTERNAL_PROXY: 'web1'
    };
    this.hostname = process.env.VOYENT_HOST || this.HOSTNAMES.DOCKER_LOCAL;
...
var schedulingService = new Service('scheduling', 55080);
env.addService(schedulingService);
