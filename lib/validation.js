...
var usernameValidator = function (val) {
    ...
    // vras-1121, this is more liberal than any other regex we could concoct.
    let result = emailValidator(val);
    if (result) {
        return true;
    }
    // If this isn't an email, then test against the regular username regex
