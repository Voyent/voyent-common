...
//
//This function removes any characters that are not allowed in the name
//and makes sure it's less than 64 characters.
function getSafeDatabaseName(accountName) {
    return accountName.replace(/[\\\/\.\"]/g, '').substring(0, 63);
}
