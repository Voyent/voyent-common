var errConstantsSpanish = {
    ...
    // constants in this file awaiting translation
    ...
    invalidGroupFormat: 'The Format of the Group is incorrect',
    ...
    invalidGroupname: 'The specified groupname is invalid',
    invalidGroupReferenceFormat: 'Group/topic reference field must be array of ids',
    ...
    userAlreadyExists: 'A user record with that username already exists',
    groupAlreadyExists: 'A group record with that name already exists',
    roleAlreadyExists: 'A role record with that name already exists',
    ...
    invalidUsernameReference: 'Format of the username reference structure is invalid',
    invalidRoleStructure: 'Format of the role record is incorrect',
    invalidGroupStructure: 'Format of the group record is incorrect',
    invalidCostRecord: 'The cost record details are invalid',
    invalidAccountServiceRecord: 'The format/content of the account service record is incorrect',
    duplicateCategories: 'The alert name + categories already exist in database',
    ...
    maximumLinkAttemptsExceeded: 'Unsuccessful link attempt maximum exceeded',
    ...
    missingAlertPasscode: 'The user record does not contain an unexpired alertPasscode',
